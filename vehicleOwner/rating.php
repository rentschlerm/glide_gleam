...
if(isset($_GET["id"])){
    // Sanitize and store the appointment ID
    $appointment_id = $database->real_escape_string($_GET["id"]);
...
<body>
    ...
    <div class="container">
    	...
    	<div class="card">
    		<div class="card-header">Carwash Shop</div>
    		<div class="card-body">
    			<div class="row">
        ...
        if (isset($result) && $result->num_rows > 0) {
            // Output data of the selected appointment
        ...
        ?>
    					...
    					<button type="button" name="add_review" id="add_review" class="btn btn-primary form-control mt-3">Rate/Review This Shop</button>
    				</div>
        ...
        <h3 class="mt-3 ml-4">Shop Reviews:</h3>
...
var appointment_id = <?php echo $appointment_id; ?>; // Retrieve appointment_id from PHP variable
...
else
{
    $.ajax({
        ...
        method:"POST",
        data:{rating_data:rating_data, user_name:user_name, user_review:user_review, appointment_id:appointment_id}, // Pass appointment_id
